...
void QtGLPlaneComponent::generate(float width, float height, float repeatX, float repeatY)
{
    ...
    for (int vert = 0; vert < 4; vert++) {
        addTextureCoord(QVector2D((vert == 0 || vert == 3) * repeatX, (vert == 0 || vert == 1) * repeatY));
