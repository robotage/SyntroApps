...
/*            qDebug() << "Device name: " << deviceInfo.deviceName();
    ...
    logDebug(QString("Audio using %1 sps and %2 channels").arg(m_outputRate).arg(m_outputChannels));
...
QByteArray SyntroView::convertAudioFormat(const QByteArray& audioData)
{
    QByteArray newData;
    int sampleLength;
    int sampleBytes;
